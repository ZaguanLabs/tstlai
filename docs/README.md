...
| Guide                                           | Description                      |
| :---------------------------------------------- | :------------------------------- |
| [Installation](getting-started/installation.md) | Install tstlai via npm/pnpm/yarn |
| [Quick Start](getting-started/quick-start.md)   | Zero to translated in 5 minutes  |
...
| :---------------------------------------- | :-------------------------------------- |
| [Core API](api/core.md)                   | `Tstlai` class, configuration options   |
| [Integrations](reference/integrations.md) | Framework-specific adapters and helpers |
